...
import ru.spring.school.online.dto.request.AdminOrTeacherRegister;
...
public class AdminController {
    ...
    public ResponseEntity<?> regAdmin(HttpServletRequest request,
                                      @RequestBody @Valid AdminOrTeacherRegister register,
                                      Errors errors
    ) {
        User user = register.toUser(passwordEncoder);
